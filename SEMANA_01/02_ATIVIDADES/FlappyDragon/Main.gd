...
var status = 1 #muda o status do jogo para "jogando"
var vscore = 0 #zera os pontos
var x = 0.15 #aumenta a velocidade do cenário
var y = 0.15 #aumenta a gravidade do dragão
